...
class Test(unittest.TestCase):
    ...
    def testAddAreaProperty(self):
        ...
        self.assertTrue(
            'PROPERTY sim/exclude_fac 10.00000000/53.61470575/10.00801022/53.65809636' in dsf.dsfFiles['+53+010'])
    ...
    def testMakeHeader(self):
        dsf = classes.DSFTool()
        output = ['I', '800', 'DSF2TEXT', '', 'PROPERTY sim/planet earth', 'PROPERTY sim/overlay 1',
                  'PROPERTY sim/creation_agent XPExclusionMaker', 'PROPERTY sim/west -81', 'PROPERTY sim/east -80',
                  'PROPERTY sim/north 27', 'PROPERTY sim/south 26']
